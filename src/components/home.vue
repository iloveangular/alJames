      ...
      <div class="home">
        ...
        <div class="main">
          ...
          <section class="packages">
            <div class="container">
              <h2><span>Why Choose Us</span>
                <router-link to="about">Learn About us</router-link>
              </h2>
              <div class="row">
                ...
                <div class="col-md-3 col-xs-6 about-block">
                  <div class="package">
                    ...
                    <p>
                      Our qualified agents will assist you throughout the entire process to ensure that you get the
                  ...
                  <div class="bg-grey-gradient brd-grey pad-20 radius-4 group-1">
                    <div class="row align-center">
                      <div class="col-md-7 col-sm-6 col-xs-12">
                        ...
                        <router-link title="Affiliate Program" class="btn btn-primary btn-custom margin-top-20"
                                     to="affiliates">Learn More
                        </router-link>
                      </div>
                  ...
                  <div class="bg-grey-gradient brd-grey pad-20 radius-4 group-1">
                    <div class="row align-center">
                      <div class="col-md-7">
                        ...
                        <router-link title="Partners Program" class="btn btn-primary btn-custom margin-top-20"
