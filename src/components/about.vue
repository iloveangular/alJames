<template>
    <main>
        <section class="banner define_float"><img src="src/assets/images/bg.png">
            <div class="col-md-10 banner_content"><img src="src/assets/images/logo.png" style="width: 200px;" class="footer-logo">
                <h3><span>Our goal is to provide the ultimate business start-up platform, to help businesses</span>
                    get up and running with all the tools at hand.</h3>
            </div>
        </section>
        <!-- -->
        <!-- about-area-->
        <section class="about define_float">
            <div class="container">
                <div class="row">
        ...
        <!-- -->
        <!-- service-area-->
        <section class="service_area define_float">
            <div class="container">
                <div class="row">
                    <div class="service_main about">
                        <h2 class="text-center">Our Products & Services</h2>
                        <div class="products">
                            <a class="txt-hover-none">
                                <div class="brd-grey">
                                    <div class="text-center">
                                        <div style="margin:20px auto;" class="bg-red">
                                            <div style="position: relative;top:15px;"
                                                 class="sprite1 register-company"></div>
                                        </div>
                                        <h6 class="mar-top-20 fnt-oswald-medium">Company Formation</h6>
                                    </div>
                                </div>
                            </a>
                            <figcaption style="display: none;" class="about-title"><a
                                    class="clr-black inl-block width-100 txt-hover-none"></a>
                                <div id="hoverOffers"><a class="clr-black inl-block width-100 txt-hover-none"></a>
                                    <div id="hoverOffers" class="bg-white brd-grey pad-20 lar-height-260 mob-pad-10">
                                        <a class="clr-black inl-block width-100 txt-hover-none">
                                            <h6 class="mar-top-20 text-center mob-mar-tp-10">Company Formation</h6>
                                            <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0 mar-top-10">
                                                Available across 5 continents, in 50+ countries</p>
                                            <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0">
                            ...
                            <a class="txt-hover-none">
                                <div class="brd-grey">
                                    <div class="text-center">
                                        <div style="margin:20px auto;" class="bg-red">
                                            <div style="position: relative;top:15px;"
                                                 class="sprite1 bank-account"></div>
                                        </div>
                                        <h6 class="mar-top-20 fnt-oswald-medium">Bank Account Opening</h6>
                                    </div>
                                </div>
                            </a>
                            <figcaption style="display: none;" class="about-title"><a
                                ...
                                <div id="hoverOffers"><a class="clr-black inl-block width-100 txt-hover-none"></a>
                                    <div id="hoverOffers" class="bg-white brd-grey pad-20 lar-height-260 mob-pad-10">
                                        <a class="clr-black inl-block width-100 txt-hover-none">
                                            <h6 class="mar-top-20 text-center mob-mar-tp-10">Bank Account Opening</h6>
                                            <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0 mar-top-10">
                                                Available across 5 continents with 40+ banks</p>
                                            <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0">
                            ...
                            <a class="txt-hover-none">
                                <div class="brd-grey">
                                    <div class="text-center">
                                        <div style="margin:20px auto;" class="bg-red">
                                            <div style="position: relative;top:15px;"
                                                 class="sprite1 register-trademark"></div>
                                        </div>
                                        <h6 class="mar-top-20 fnt-oswald-medium">Trademark Registration</h6>
                                    </div>
                                </div>
                            </a>
                            <figcaption style="display: none;" class="about-title"><a
                                ...
                                <div id="hoverOffers"><a class="clr-black inl-block width-100 txt-hover-none"></a>
                                    <div id="hoverOffers" class="bg-white brd-grey pad-20 lar-height-260 mob-pad-10">
                                        <a class="clr-black inl-block width-100 txt-hover-none">
                                            <h6 class="mar-top-20 text-center mob-mar-tp-10">Trademark Registration</h6>
                                            <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0 mar-top-10">
                                                Available across 5 continents, in 70+ countries.</p>
                                            <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0">
                            ...
                            <a class="txt-hover-none">
                                <div class="brd-grey">
                                    <div class="text-center">
                                        <div style="margin:20px auto;" class="bg-red">
                                            <div style="position: relative;top:15px;"
                                                 class="sprite1 special-offers"></div>
                                        </div>
                                        <h6 class="mar-top-20 fnt-oswald-medium">Business eBooks</h6>
                                    </div>
                                </div>
                            </a>
                            <figcaption style="display: none;" class="about-title"><a
                                ...
                                <div id="hoverOffers"><a class="clr-black inl-block width-100 txt-hover-none"></a>
                                    <div id="hoverOffers" class="bg-white brd-grey pad-20 lar-height-260 mob-pad-10">
                                        <a class="clr-black inl-block width-100 txt-hover-none">
                                            <h6 class="mar-top-20 text-center mob-mar-tp-10">Business eBooks</h6>
                                            <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0 mar-top-10">
                            ...
                            <a class="txt-hover-none">
                                <div class="brd-grey">
                                    <div class="text-center">
                                        <div style="margin:20px auto;" class="bg-red">
                                            <div style="position: relative;top:15px;"
                                                 class="sprite1 download-docs"></div>
                                        </div>
                                        <h6 class="mar-top-20">Business Documents</h6>
                                    </div>
                                </div>
                            </a>
                            <figcaption style="display: none;" class="about-title"><a
                                    class="clr-black inl-block width-100 txt-hover-none"></a>
                                <div id="hoverOffers"><a class="clr-black"></a>
                                    <div id="hoverOffers" class="bg-white brd-grey pad-20 lar-height-260 mob-pad-10">
                                        <a class="clr-black inl-block width-100 txt-hover-none">
                                            <h6 class="mar-top-20 text-center mob-mar-tp-10">Business Documents</h6>
                                            <div class="text-left inl-block mar-tb-10">
                                                <div class="inl-block">
                                                    <p class="fnt-size-13 mob-fnt-size-13 clr-l-grey fnt-sans-semi-bold mar-btm-0 text-center">
        ...
        <!-- -->
        <!-- tab-area-->
        <section class="tab_area define_float">
            <div class="container">
                <div class="row">
                    <div class="tab_main">
