          ...
          <section class="informations">
            <div class="block">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-4">
                    <p class="step-text">Set up your New Company in 4 STEPS</p>
                  </div>
                  <div class="col-md-8">
          ...
          <section class="panel-start">
            <div class="container">
              <div class="row">
                <div class="panel">
                  <div class="col-md-6">
                    <h6 class="fnt-size-24 mob-fnt-size-21">Select your country formation</h6></div>
                  <div class="col-md-6">
                    ...
                    <div v-for="cp in companies"
                      ...
                      <div class="col-md-12 small-panel hidden-xs">
                        <div class="col-md-6 lar-width-48">
                          <div class="left">
                            <img class="flg-sml" :src="cp.flagImageUrl"></div>
              ...
              <div class="row">
                <div class="panel-two">
                  <div class="col-md-6 col-sm-6">
                    <h6 class="fnt-size-24 mob-fnt-size-21">Browse Companies by Region</h6></div>
                  <div class="col-md-6 col-sm-6 btn-hide">
                    <a class="button-green" href="/companies/compare" title="Jurisdictions">
                      <div class="inl-block mar-top-5"><span
                        class="fnt-oswald-medium fnt-size-21">Compare Companies</span>
                ...
                <div class="col-md-6 col-sm-6 btn-show" style="display: none;">
                </div>
              </div>
            </div>
          </section>
              ...
              <div class="row">
                ...
                <div class="tab">
                  <button class="tablinks active" id="defaultOpen"
                          onclick="openCity(event, 'London')">Our services include
                  </button>
                  <button class="tablinks" onclick="openCity(event, 'Paris')">Documents Required
                  </button>
                  <button class="tablinks" onclick="openCity(event, 'Tokyo')">Business Activities
                  </button>
                  <button class="tablinks" onclick="openCity(event, 'Tokyo2')">Shipping Cost</button>
                </div>
                <div class="tabcontent" id="London" style="display: block;">
                  <div>
                    <p>Our standard services include</p>
                    <ul>
                ...
                <div class="tabcontent" id="Tokyo" style="display: none;">
                  <section class="content pad-0 active" id="panel2-3" role="tabpanel"
                           aria-hidden="false">
                    <p>
                ...
                <div class="tabcontent" id="Tokyo2" style="display: none;">
                  <div>
                    <p>
              ...
              <div class="panel-group" id="accordion1">
                <div class="panel panel-default">
                  <div class="panel-heading accordion-toggle collapsed" data-toggle="collapse"
                       data-parent="#accordion1" data-target="#collapse-08" aria-expanded="false">
                    <h4 class="panel-title">Our services include</h4></div>
                  <div class="panel-collapse collapse" id="collapse-08" aria-expanded="false"
                       style="height: 0px;">
                    <div class="panel-body">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading accordion-toggle collapsed" data-toggle="collapse"
                       data-parent="#accordion1" data-target="#collapse-09" aria-expanded="false">
                    <h4 class="panel-title">Documents Required</h4></div>
                    ...
                    <div class="panel-body">
                      <div class="tabcontent1" id="Paris">
                        <div>
                          ...
                          <ul>
                            <li><strong>Notarized copy of valid passport.</strong>
                              The passport must be signed and signature must match the signature in the application
                              form. The photograph must be clear and of good quality.
                            </li>
                            <li><strong>Original or Certified copy of utility bill / bank statement</strong>
                              (as verification of residential address, dated within 3 months); the household utility
                              bill (e.g. gas, electricity, water or fixed line telephone but <strong>not a mobile phone
                                bill</strong>) or bank, building society or credit card statement as proof of address.
                              It must be no more than 3 months old and show your name and current address. P.O. Box is
                              not accepted.
                            </li>
                            <li><strong>Original or certified copy of Banker's reference letter</strong>
                              (dated within 3 months). You can request the Reference Letter from the bank where you hold
                              an account. The reference letter should include confirmation that the relationship has
                              been maintain for longer than 2 years and the business affairs are run satisfactorily.
                            </li>
                            <li><strong>In cases where shareholders and/or directors are corporate bodies, full
                              apostilled set of corporate documents will be required:</strong>
                              Certificate of Incorporation, List of Directors, Shareholders, Secretary, Share
                              Certificate, copy of 'Declaration of Trust' between nominee shareholder(s) and ultimate
                              beneficial owner(s) (if applicable), Certificate of Good Standing (if the company has been
                              operating for 12 months or more); Notarized copy of a valid passport, utility bill and the
                              reference letter for each individual Director, Shareholder and Beneficial Owner.
                            </li>
                          </ul>
                        </div>
                      </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading accordion-toggle collapsed" data-toggle="collapse"
                       data-parent="#accordion1" data-target="#collapse-10" aria-expanded="false">
                    ...
                    <div class="panel-body">
                      <div class="tabcontent1" id="Tokyo">
                        <section class="content pad-0 active" id="panel2-3" role="tabpanel"
                          ...
                          <p><strong>Licensable Activities:</strong>
                            If you conduct any activity without required license or authorization granted by a relevant
                            authority in any jurisdiction, Agent Legal will not be able to assist you with the or bank
                            account opening related to such unlicensed activity.
                          </p>
                          <p>
                            Licensable activities include, but not limited to: provision of financial services involving
                            trading/brokerage in foreign exchange, financial and commodity-based derivative instruments
                            and other securities; offering investment advice to public; insurance and banking business;
                            operation and administration of collective investment schemes and mutual funds; payment
                            processing services; money exchange, money transmission or money brokering; asset
                            management; safe custody services; gaming, gambling and lotteries.</p>
                          <p><strong>Please <a
                            href="mailto:support@agentlegal.com">contact us</a>
                            if you need our assistance in
                            licensing
                            of
                            your financial, Forex brokerage or gambling company.</strong>
                          </p>
                          <p>
                            The following categories of businesses are prohibited from using Agent Legal services:</p>
                          <ul>
                            ...
                            <li>
                              Human or animal organs, the abuse of animals or use of animals for any scientific or
                              product testing;
                            </li>
                            <li>Genetic material;</li>
                            <li>
                            ...
                            <li>
                              Any other activity, which, in the opinion of Agent Legal, may damage the reputation of
                              Agent Legal or that of the country of formation of the Entity.
                            </li>
                          </ul>
                        </section>
                      </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading accordion-toggle collapsed" data-toggle="collapse"
                       data-parent="#accordion1" data-target="#collapse-11" aria-expanded="false">
                  ...
                  <div class="panel-collapse collapse" id="collapse-11" aria-expanded="false">
                    <div class="panel-body">
                      <div class="tabcontent1" id="Tokyo2">
                        <div>
                          <p>
                            Shipping of corporate documents or banking kits to your destination requires an extra charge
                            and will be automatically added to the invoice during checkout. Shipping costs for
                            international courier services are set automatically and can vary from USD 75 to USD 95. The
                            fees depend on the jurisdiction of your ordered company, the country where the bank is based
                            as well as your destination country.</p>
                        </div>
                      </div>
                    </div>
                  </div>
