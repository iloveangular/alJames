            ...
            <div class="container">
                <div class="trademark-registration">
                    ...
                    <div class="trademark-text">
                        <p>
                            ...
                            Registration, to ensure its approval. You can request the Trademark Search <a
                                href="/#/trademarks/search">here</a>.</p>
                        <p><span>Select what you want to register and give information accordingly</span></p>
                    </div>
                    <div class="trademark-registration-form">
                        ...
                        <div class="row">
                            <div class="col-xs-6 radio-last-space">
                                <span>Has this Trademark been used in commerce?</span>
                            ...
                            <ul>
                                <li v-for="(country, index) in countries">
                                    <label :for="'chk' + (index + 1)">
                                        <input :id="'chk' + (index + 1)" class="terr" name="territories"
                                               :value="country.name"
                                               :data-price="country.price" :data-id="country._id"
                                               :data-class-price="country.classPrice"
                                        ...
                                        <li v-for="(klasa, index) in classes" :class="index + 1">
                                            <label :for="'cls' + (index + 1)">
                                                <input class="cls" :id="index + 1" name="classes"
                                                       ...
                                                       type="checkbox"><span><b>{{ index + 1
                                                }}</b></span><span> {{klasa.text}}</span></label>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="tab-content" id="form-4" style="display:block;">
                                ...
                                <div class="large-12 column form-group">
                                    <label class="mar-btm-5" for="country" role="alert">Country<span
                                            class="star">*</span></label>
                                    <select class="input-fields form1-country" id="ind_country" name="country"
                                            data-invalid=""
                                            aria-invalid="true">
                                ...
                                <div class="large-12 column form-group">
                                    <label class="mar-btm-5" for="phone">Telephone No.<span
                                            class="star">*</span></label>
                                    <input id="ind_telephone" name="phone" class="form1-phone" placeholder=""
                                           type="text">
                            ...
                            <div class="tab-content" id="form-5" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <div class="large-6 column">
                                        <label class="mar-btm-5" for="lastname">Last Name<span
                                                class="star">*</span></label>
                                        <input id="ind_last_name" name="lastname" class="form2-lastName" placeholder=""
                                               type="text">
                                        <small class="error">Last Name is required</small>
                                    </div>
                                </div>
                                <div class="large-12 column form-group">
                                    <label class="mar-btm-5" for="company" role="alert">Nationality<span
                                            class="star">*</span></label>
                                    <input id="comp_name" name="company" value="" class="form2-nationality"
                                           placeholder=""
                                           data-invalid=""
                                ...
                                <div class="large-8 column form-group">
                                    <label class="mar-btm-5" for="address">Address<span
                                            class="star">*</span></label>
                                    <input id="ind_address" name="address" placeholder="" class="form2-address"
                                           type="text">
                                    <small class="error">Address is required</small>
                                </div>
                                <div class="large-4 column form-group">
                                    <label class="mar-btm-5" for="postalCode">Postal Code<span
                                            class="star">*</span></label>
                                    <input id="ind_post_code" name="postalCode" placeholder="" class="form2-zip"
                                           type="text">
                                    <small class="error">Postal Code is required</small>
                                </div>
                                <div class="large-12 column form-group">
                                ...
                                <div class="large-12 column form-group">
                                    <label class="mar-btm-5" for="country" role="alert">Country<span
                                            class="star">*</span></label>
                                    <select class="input-fields form2-country" id="ind_country" name="country"
                                            data-invalid=""
                                            aria-invalid="true">
                                        <option value="">Please Select Country</option>
                                        <option>Afghanistan</option>
                                ...
                                <div class="large-12 column form-group">
                                    <label class="mar-btm-5" for="phone">Telephone No.<span
                                            class="star">*</span></label>
                                    <input id="ind_telephone" name="phone" placeholder="" class="form2-phone"
                                           type="text">
                                    <small class="error">Telephone No is required</small>
                                </div>
                                <div class="large-12 column form-group">
            ...
            <div class="container">
                ...
                <div id="accordion" class="panel-group">
                    <div class="panel panel-default">
                        <div id="accordion-toggle-1" data-toggle="collapse" data-parent="#accordion"
                             data-target="#collapseOne" aria-expanded="false"
                             class="panel-heading accordion-toggle collapsed">
                            <div class="sprite1 about_tm-01"></div>
                            <h4 class="panel-title">About</h4>
                        </div>
                        <div id="collapseOne" aria-expanded="false" style="height: 0px;"
                             class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>
                                    A Trademark is a symbol, phrase, design or word that helps distinguish one manufacturer of goods from another. It is a key identifier of a company used all over the world. An example of a famous trademark is Apple, which is represented
                                ...
                                <p>
                                    'Intellectual property,' however, has no physical embodiment that one can see, touch or feel such as literature and music. Trade names, artistic designs and digital programming are also part of the intellectual property band. Like physical
                                ...
                                <p>
                                    Trademarks adopt rights in two ways: 1) by registration, and 2) by using the mark first. Both ways can be protected. By registering, you will gain many advantages from the federal law, including the use of the ® symbol on your trademark.
                                ...
                                <p>
                                    Before adopting a new mark, it is advisable to have a search conducted and evaluated by a qualified attorney. Someone else may already have rights to virtually the same mark, and it is better to know about that or other potentially conflicting
                                    ...
                                    to be covered by the registration, and the official filing fee. In some jurisdictions, it may also be necessary to file specimens showing how the mark is used. However, most countries do not require a mark to be used before it is registered.</p>
                                <b>Trademark Symbols</b>
                                <p>
                                    Trademarks are often used with designations or symbols, i.e. ®, also known as Reg., TM, and SM. These symbols work as trademark identifiers classifying whether or not a trademark is registered. Unregistered Trademarks use the symbols
                    ...
                    <!-- start-->
                    <div class="panel panel-default">
                        <div id="accordion-toggle-2" data-toggle="collapse" data-parent="#accordion"
                        ...
                        <div id="collapseTwo" aria-expanded="false" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>
                                    A Trademark is the key identifier of a business so it is only normal to want to protect it from unauthorized users. Using a trademark without registration will not come with many benefits. The main concern is that there will always be
                    ...
                    <!-- start-->
                    <div class="panel panel-default">
                        <div id="accordion-toggle-3" data-toggle="collapse" data-parent="#accordion"
                        ...
                        <div id="collapseThree" aria-expanded="false" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>
                                    At Agent Legal, we make sure that our customers receive the best prices possible for their trademark registration. Please keep in mind that each jurisdiction will have a trademark authority, used to protect your trademark for a small
                                    fee.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- start-->
                    <div class="panel panel-default">
                        <div id="accordion-toggle-4" data-toggle="collapse" data-parent="#accordion"
                        ...
                        <div id="collapseFour" aria-expanded="false" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>
                                    Before registering, it is recommended to check the availability of your suggested trademark. You can do this by simply conducting a search using our 'Trademark Search' section. By doing a thorough search, you eliminate any possibilities
                    ...
                    <!-- start-->
                    <div class="panel panel-default">
                        <div id="accordion-toggle-5" data-toggle="collapse" data-parent="#accordion"
                        ...
                        <div id="collapseFive" aria-expanded="false" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>
                                    Still not convinced to perform a Trademark search? You will be shocked to find out that not all trademark authorities go through the process of investigating whether or not a trademark already exists. This can accumulate chaos as authorities
                    ...
                    <!-- start-->
                    <div class="panel panel-default">
                        <div id="accordion-toggle-6" data-toggle="collapse" data-parent="#accordion"
                        ...
                        <div id="collapseSix" aria-expanded="false" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <div class="mar-btm-20">
                                    ...
                                    <p>
                                        Once your application has been processed by the Trademarks Authority, examiners will begin the initial examination to ensure that all the formal requirements of the application form have been satisfied as set out in the Trademarks
                                ...
                                <div class="mar-btm-20">
                                    ...
                                    <p>
                                        Publication of the trademark in the Official Gazette is mandatory as third parties have the right to object to the registration within a specific time frame by filing an opposition. In case a third party opposes your registration,
