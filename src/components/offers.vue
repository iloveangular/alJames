                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="box">
                                    ...
                                    <p>
                                        Personal account in Latvia with prestigious World Elite MasterCard: discount programs, large
                            ...
                            <div class="col-md-4">
                                <div class="box">
                                    ...
                                    <p>
                                        Obtain a Visa Infinite Card with an Emirates NBD bank account. Includes: special discount
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get(config.url + 'special-offers')
