        ...
        <section class="registration-form">
            <div class="container">
                <div class="trademark-registration">
                    <h4>1.Trademark Search</h4>
                    <div class="trademark-text">
                        <p>Select the type of trademark you wish to search for</p>
                    </div>
                ...
                <div class="trademark-registration owner-details total-price">
                    <h4>Trademark Search</h4><span>Territories </span><span
                    ...
                    <div class="col-xs-12 text-right" style="padding: 0;">
                        <div class="price-div">
                            ...
                            <div class="form-actions">
                                <button id="continueButton" class="price-green button green continue"
                                        style="width: auto !important;">Request a Quote
                                </button>
                            </div>
