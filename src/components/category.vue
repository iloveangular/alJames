      ...
      <section class="document-div">
        <div class="container">
          <div class="col-xs-12" style="padding: 0; border-bottom: 1px dashed #dddddd;">
            <h1 style="text-transform:capitalize;">{{title}} Documents</h1><a class="back-link" href="/#/documents">&lt;
          ...
          <div class="search-div">
            ...
            <button class="button green no-brd pad-tb-2-lr-15" id="search_doc" type="submit" name="submit"
                    style="height:37px;">
              ...
              <div class="inl-block-cart">
                <div class="mob-float-none">
                  <form id="formundefined" method="post">
                    ...
                    <button class="button-cart green" type="submit" name="button_id" value="5999d9953a95f667e1812697"
                            style="float:left;">Add to Cart
                    </button>
                  </form>
                  <a class="button-cart grey" :href="'/#/document/' + vm.slug">Learn
                    More</a></div>
                <div class="hide-for-small-down">
                  <div class="inl-block left">
                    <h6 class="clr-green docPrice left mar-rgh-10 mar-top-7">PRICE {{value}}{{vm.price * rate | fixPrice}}</h6></div>
                </div>
              </div>
            </div>
            <div class="col-xs-4 col-sm-2 padding-remove"><img :src="vm.image.url" data-toggle="modal"
                                                               data-target="#myModal">
