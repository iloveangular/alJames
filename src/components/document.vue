                    ...
                    <div class="row">
                            ...
                            <div class="modal fade" id="myModal" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"><img class="model-img"
                                                                     src="src/assets/img/company-img.jpg"
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-7">
                            ...
                            <p>
                                ...
                                please <a href="/#/contact" style="float: none; margin: none;">contact us</a>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="doc-box">
                                <h6 style="text-transform: uppercase;">
                                    Price<span>{{value}}{{document.price * rate | fixPrice}}</span>
                                </h6>
                                <button class="add-to-cart addToCart" name="button_id"
                                        value="5999d9973a95f667e18126a0">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
