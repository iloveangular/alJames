                    ...
                    <div class="col-lg-12">
                        <form method="post">
                            ...
                            <table class="table payment-table" id="view_product">
                                ...
                                <tr class="form-group" v-for="service in services.slice(0, 1) " :key="service.type == 'nominee-service'" v-if="service.type == 'nominee-service'">
                                ...
                                <tr class="form-group" v-for="service in services.slice(0, 1) " :key="service.type == 'corporate-certificate'" v-if="service.type == 'corporate-certificate'">
                                    <td class="payment-table-sub-head" colspan="2">
                                ...
                                <tr class="form-group" v-for="service in services.slice(0, 1) " :key="service.type == 'other-service'" v-if="service.type == 'other-service'">
                                    <td class="payment-table-sub-head" colspan="2">
                                ...
                                <tr class="hidden">
                                    ...
                                    <td class="payment-price">$ <span class="product_total" id="price">{{product.price}}</span></td>
                                </tr>
                                </tbody>
                            </table>
        ...
        <section class="about_prod">
            <div class="container">
                <div class="row" id="about_prod">
                    <div class="col-lg-12">
                        <!-- Accordions-->
                        <h2>Facts &amp; Info for {{product.name}}</h2>
                        <div class="panel-group" id="accordion-about">
                            <div class="panel">
                                <h3><a class="clearfix" data-toggle="collapse" data-parent="#accordion-about"
                                       href="#about-1"><span class="corporate-info-icon panel-title-icon"></span><span
                                        class="panel-title">About the Bank</span><span
                                        class="accordion-arrow"></span></a></h3>
                                <div class="panel-collapse collapse" id="about-1">
                                    <div class="panel-body" v-html="product.aboutTheBank">
                                    </div>
                                </div>
                            </div>
                            <div class="panel">
                                <h3><a class="clearfix" data-toggle="collapse" data-parent="#accordion-about"
                                       href="#about-2"><span class="taxation-icon panel-title-icon"></span><span
                                        class="panel-title">Facilities</span><span class="accordion-arrow"></span></a>
                                </h3>
                                <div class="panel-collapse collapse" id="about-2">
                                    <div class="panel-body" v-html="product.facilities"></div>
                                </div>
                            </div>
                            <div class="panel">
                                <h3><a class="clearfix" data-toggle="collapse" data-parent="#accordion-about"
                                       href="#about-3"><span class="services-icon panel-title-icon"></span><span
                                        class="panel-title">Our Services &amp; Requirements</span><span
                                        class="accordion-arrow"></span></a></h3>
