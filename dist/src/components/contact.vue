<template>
    <main class="contact-us-page page-content">
        <section class="contact-text">
            <div class="container">
                <h1>Contact Us</h1>
                <p>Call, email us or complete our contact form below to contact Agent Legal if you have any questions and queries regarding any of our company registration and associated services.</p>
            </div>
        </section>
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="contact-form contact-section clearfix">
                            <div class="contact-section-head">
                                <h2>Contact Form <span>All fields are mandatory</span></h2></div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" id="message" name="message" rows="9" cols="39"></textarea>
                                    </div>
                                </div>
