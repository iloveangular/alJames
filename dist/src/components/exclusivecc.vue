                        ...
                        <form method="post">
                            ...
                            <table class="table payment-table" id="view_product">
                                ...
                                <tr>
                                    <td class="payment-item">
                                        <div class="payment-item-title"><a data-toggle="collapse" href="#panel-0"><span class="more_info"></span> Personal Account Opening (Emirates NBD)</a></div>
                                        <div class="payment-item-info collapse" id="panel-0">Personal account opening with Emirates NBD Bank
                                            <ul>
                                                ...
                                                <li>Completion of the bank forms for account opening and internet banking facilities, which will be forwarded to you for signing with relevant instructions</li>
                                            ...
                                            <br> We consider our service completed once you obtain the bank account number. Due to the banker-customer relationship, we will no longer be able to contact the bank on your behalf after the bank account is opened.
                                            <br>
                                            <br>
                                            <b>Please note:</b> Personal presence will be required for 1 day to open the account. Our representatives will arrange a meeting and accompany you to the bank.</div>
                                    </td>
                                    <td class="payment-price mandatory-price">
                                        <input class="hidden" style="height:12px;margin-top:3px;" name="options[29780]" value="795" checked="checked" type="checkbox"> $<span>695</span></td>
                                </tr>
                                <tr class="form-group">
                                ...
                                <tr>
                                    <td class="payment-item">
                                        <div class="payment-item-title"><a data-toggle="collapse" href="#panel-included-0"><span class="more_info"></span> Visa Infinite Card</a></div>
                                        <div class="payment-item-info collapse" id="panel-included-0">
                                            <ul>
                                                ...
                                                <li>Completion of Credit Card Application, which will be forwarded to you for signing with relevant instructions.</li>
                                                <li>Monitoring the card issuance process until the card is received.</li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td class="payment-price mandatory-price"> $<span>100</span></td>
                                </tr>
                                <tr>
                                    <td class="payment-table-head" colspan="2">
                                ...
                                <tr>
                                    <td class="payment-item">
                                        <div class="payment-item-title"><a data-toggle="collapse" href="#panel-1"><span class="more_info"></span><span>Additional Visa Infinite Card</span></a></div>
                                        <div class="payment-item-info collapse" id="panel-1">
                                            <ul>
                                                ...
                                                <li> Assistance with obtaining of one additional Infinite Credit Card linked to main cardholder's account with Emirates NBD bank:</li>
                                                <li>Completion of Credit Card Application, which will be forwarded to you for signing with relevant instructions.</li>
                                                <li>Monitoring the card issuance process until the card is received.</li>
                                            </ul>
                                        </div>
                                    ...
                                    <td class="payment-price">$<span>100</span>
                                        <input class="checkbox" name="services" value="59c704d3786e09accc26d23a" data-price="100" type="checkbox">
                                    </td>
                                </tr>
                                <tr class="hidden payment-calculation">
                                    ...
                                    <td class="payment-price"><span>{{product.price}}</span>
                                ...
                                <tr class="hidden">
                                    ...
                                    <td class="payment-price">$ <span class="product_total" id="price">795</span></td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table total-table">
                                ...
                                <tr>
                                    ...
                                    <td class="no-pad-left total-price">TOTAL: $<span id="total">{{product.price}}</span>
                ...
                <div class="row" id="about_prod">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-group" id="accordion-about">
                            <div class="panel">
                                <h3><a class="clearfix" data-toggle="collapse" data-parent="#accordion-about" href="#about-1"><span class="corporate-info-icon panel-title-icon"></span><span class="panel-title">About the Card</span><span class="accordion-arrow"></span></a></h3>
                                <div class="panel-collapse collapse" id="about-1">
                                    <div class="panel-body"></div>
                                </div>
                            </div>
                            <div class="panel">
                                <h3><a class="clearfix" data-toggle="collapse" data-parent="#accordion-about" href="#about-2"><span class="corporate-info-icon panel-title-icon"></span><span class="panel-title">About the Bank</span><span class="accordion-arrow"></span></a></h3>
                                <div class="panel-collapse collapse" id="about-2">
                                    <div class="panel-body"></div>
                                </div>
                            </div>
                            <div class="panel">
                                <h3><a class="clearfix" data-toggle="collapse" data-parent="#accordion-about" href="#about-2"><span class="services-icon panel-title-icon"></span><span class="panel-title">Requirements</span><span class="accordion-arrow"></span></a></h3>
                                <div class="panel-collapse collapse" id="about-2">
                                    <div class="panel-body"></div>
                                </div>
                            </div>
